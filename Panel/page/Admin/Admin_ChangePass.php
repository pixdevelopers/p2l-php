...
elseif($General->CheckPrivilege('Admin_Manage') == '0' AND $_GET['ID'] != $_SESSION['AdminID']){
    $show_page = '0';
                    ...
                    <div class="col-sm-12">
                        <div class="panel panel-flat" style="padding-top: 15px;">
                            <?php if($show_page == '1') { ?>
                                ...
                                <form action="Admin_action.php?action=change_pass&ID=<?php echo $row_info['ID']; ?>" method="post" target="_blank">
                                    <div class="col-sm-12">
                                        <div class="col-sm-4">
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <div style="clear: both"></div>
                                            <input type="text" name="Username" value="<?php echo $row_info['Username']; ?>" disabled>
                                        </div>
                                        <div class="col-sm-4">
