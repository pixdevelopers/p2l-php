...
elseif(isset($_GET['ID'])) {
    $info = $Users->SelectAdmin($_GET['ID'],'','','','','','1');
                    ...
                    <div class="col-sm-12">
                        <div class="panel panel-flat" style="padding-top: 15px;">
                            <?php if($show_page == '1') { ?>
                                ...
                                <form action="Admin_action.php?action=edit&ID=<?php echo $row_info['ID']; ?>" method="post" target="_blank">
                                    <div class="col-sm-12">
                                        <div class="col-sm-4">
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <div style="clear: both"></div>
                                            <input type="text" name="Username" value="<?php echo $row_info['Username']; ?>">
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                        <div class="col-sm-4">
                                            <label class="control-label">Member of</label>
                                            <div style="clear: both"></div>
                                            <select name="GroupID">
                                                <option value=""  >------</option>
                                                <?php $list_groups = $UserGroups->SelectUserGroups('1','','','1','','','','');
                                                while($row_group = mysqli_fetch_assoc($list_groups)) { ?>
                                                    <option value="<?php echo $row_group['ID']; ?>" <?php if($row_group['ID'] == $row_info['GroupID']){ echo 'selected';} ?> ><?php echo $row_group['Name']; ?></option>
                                                    <?php
                                                } ?>
                                            </select>
                                        </div>
                                        <div class="col-sm-3">
                                            <input type="checkbox" name="IsSuperadmin" value="1" <?php if($row_info['IsSuperadmin'] == '1'){ echo 'checked'; } ?>>
                                            Supervisor
                                        </div>
                                        <div class="col-sm-3">
                                            <input type="checkbox" name="Status" value="1" <?php if($row_info['Status'] == '1'){ echo 'checked'; } ?>>
                                            Enable
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
