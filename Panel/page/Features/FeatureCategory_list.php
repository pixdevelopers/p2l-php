                                ...
                                <table border="1" width="100%">
                                    ...
                                    while($row = mysqli_fetch_assoc($List)){
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="FeatureCategory_edit.php?ID=<?php echo $row['ID']; ?>">Edit</a>&nbsp;&nbsp;
                                                <a href="Features_action.php?action=delete_category&ID=<?php echo $row['ID']; ?>" target="_blank">Delete</a>&nbsp;&nbsp;
                                            </td>
                                        </tr>
                                        <?php
                                        $i++;
