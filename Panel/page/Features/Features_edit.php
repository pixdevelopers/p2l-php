...
elseif($General->CheckPrivilege('Features_Manage') == '0'){
    $show_page = '0';
    $error = 'Your account doesn\'t have sufficient privilege to this part! ';
}
elseif(isset($_GET['ID'])) {
    $info = $Features->Select('','','','','1');
                    ...
                    <div class="col-sm-12">
                        <div class="panel panel-flat" style="padding-top: 15px;">
                            <?php if($show_page == '1') { ?>
                                ...
                                <form action="Features_action.php?action=edit&ID=<?php echo $row_info['ID']; ?>" method="post" target="_blank">
                                    <div class="col-sm-12">
                                        <div class="col-sm-3">
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            <div style="clear: both"></div>
                                            <input type="text" name="Desc" value="<?php echo $row_info['Desc']; ?>">
                                        </div>
                                        <div class="col-sm-2">
                                        ...
                                        <div class="col-sm-2">
                                            ...
                                            <select name="CategoryID" required>
                                                <option value="">----</option>
                                                <?php
                                                $ListCategory = $Features->SelectCategory('','1','','','');
                                                while($category = mysqli_fetch_assoc($ListCategory)){
                                                    ?>
                                                    <option value="<?php echo $category['ID']; ?>" <?php if($category['ID'] == $row_info['CategoryID']){ ?> selected <?php } ?>><?php echo $category['Name']; ?></option>
                                                    <?php
                                                }
                                                ?>
                                            </select>
