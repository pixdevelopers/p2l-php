                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                if($row['CategoryID'] != '' AND $row['CategoryID'] != '0') {
                                                    $CategoryInfo = $Features->SelectCategory($row['CategoryID'], '', '', '', '1');
                                                    $row_category = mysqli_fetch_assoc($CategoryInfo);
                                            ...
                                            <td>
                                                <a href="Features_edit.php?ID=<?php echo $row['ID']; ?>">Edit</a>&nbsp;&nbsp;
                                                <a href="Features_action.php?action=delete&ID=<?php echo $row['ID']; ?>" target="_blank">Delete</a>&nbsp;&nbsp;
                                            </td>
                                        </tr>
                                        <?php
                                        $i++;
