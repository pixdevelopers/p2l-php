                            ...
                            <?php if($show_page == '1') { ?>
                                ...
                                while($row = mysqli_fetch_assoc($List)){
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="Package_edit.php?ID=<?php echo $row['ID']; ?>">Edit</a>&nbsp;&nbsp;
                                            <a href="Package_action.php?action=delete&ID=<?php echo $row['ID']; ?>" target="_blank">Delete</a>&nbsp;&nbsp;
                                        </td>
                                    </tr>
                                    <?php
                                    $i++;
