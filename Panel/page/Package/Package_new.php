                    ...
                    <div class="col-sm-12">
                        <div class="panel panel-flat" style="padding-top: 15px;">
                            <?php if($show_page == '1') { ?>
                                ...
                                <form action="Package_action.php?action=new" method="post" target="_blank">
                                    <div class="col-sm-12">
                                        <div class="col-sm-4">
                                        ...
                                        <!--<div class="col-sm-4">
                                            <input type="checkbox" name="IsSpecial" value="1" checked>
                                            Special package
                                        </div>-->
                                    </div>
                                    <div class="col-sm-12">
                                        ...
                                        while($row_list_features = mysqli_fetch_assoc($list_features)){
                                            ...
                                            <div class="col-sm-3">
                                                <input type="checkbox" name="Features[]" value="<?php echo $row_list_features['ID']; ?>" checked>
