                    ...
                    <div class="col-sm-12">
                        <div class="panel panel-flat" style="padding-top: 15px;">
                            <?php if($show_page == '1') { ?>
                                ...
                                <form action="User_action.php?action=change_pass_user&ID=<?php echo $row_info['ID']; ?>" method="post" target="_blank">
                                    <div class="col-sm-12">
                                        <div class="col-sm-3">
                                            <label class="control-label">Email</label>
                                            <div style="clear: both"></div>
                                            <input type="text" name="Email" value="<?php echo $row_info['Email']; ?>" disabled>
                                        </div>
                                        <div class="col-sm-3">
                                            <label class="control-label">Name</label>
                                            <div style="clear: both"></div>
                                            <input type="text" name="Name" value="<?php echo $row_info['Name']; ?>" disabled>
                                        </div>
                                        <div class="col-sm-3">
                                            <label class="control-label">Family</label>
                                            <div style="clear: both"></div>
                                            <input type="text" name="Family" value="<?php echo $row_info['Family']; ?>" disabled>
                                        </div>
                                        <div class="col-sm-3">
