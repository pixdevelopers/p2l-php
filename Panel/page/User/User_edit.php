...
elseif($General->CheckPrivilege('User_Manage') == '0'){
    $show_page = '0';
    $error = 'Your account doesn\'t have sufficient privilege to this part! ';
}
elseif(isset($_GET['ID'])) {
    $info = $Users->SelectUser($_GET['ID'],'','','','','','','','','1');
                    ...
                    <div class="col-sm-12">
                        <div class="panel panel-flat" style="padding-top: 15px;">
                            <?php if($show_page == '1') { ?>
                                ...
                                <form action="User_action.php?action=edit&ID=<?php echo $row_info['ID']; ?>" method="post" target="_blank">
                                    <div class="col-sm-12">

                                        <div class="col-sm-4">
                                            <label class="control-label">Email</label>
                                            <div style="clear: both"></div>
                                            <input type="text" name="Email" value="<?php echo $row_info['Email']; ?>">
                                        </div>
                                        <div class="col-sm-4">
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <div style="clear: both"></div>
                                            <input type="text" name="Family" value="<?php echo $row_info['Family']; ?>">
                                        </div>
                                        <div class="col-sm-3">
                                            <input type="checkbox" name="Disabled" <?php if($row_info['Status'] == '0'){ echo 'checked'; } ?>>
                                            Disabled
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
