                    ...
                    <div class="col-sm-12">
                        <div class="panel panel-flat" style="padding-top: 15px;">
                            <?php if($show_page == '1') { ?>
                                ...
                                <?php
                                $i = '1';
                                $List = $UserGroups->SelectUserGroups('1','','','','','','','');
                                while($row = mysqli_fetch_assoc($List)){
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="UsersGroups_edit.php?ID=<?php echo $row['ID']; ?>">Edit</a>&nbsp;&nbsp;
                                            <a href="UsersGroups_action.php?action=delete&ID=<?php echo $row['ID']; ?>" target="_blank">Delete</a>&nbsp;&nbsp;
                                        </td>
                                    </tr>
                                    <?php
                                    $i++;
