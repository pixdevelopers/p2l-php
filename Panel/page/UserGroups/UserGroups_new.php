                    ...
                    <div class="col-sm-12">
                        <div class="panel panel-flat" style="padding-top: 15px;">
                            <?php if($show_page == '1') { ?>
                                ...
                                <form action="UsersGroups_action.php?action=new" method="post" target="_blank">
                                    <div class="col-sm-12">
                                        <div class="col-sm-4">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        while($row_list_privilege = mysqli_fetch_assoc($list_privilege)){
                                            ...
                                            <div class="col-sm-3">
                                                <input type="checkbox" name="Privileges[]" value="<?php echo $row_list_privilege['Name']; ?>" checked>
