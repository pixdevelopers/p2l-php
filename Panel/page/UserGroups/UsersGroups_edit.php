...
elseif($General->CheckPrivilege('UsersGroups_Manage') == '0'){
    $show_page = '0';
    $error = 'Your account doesn\'t have sufficient privilege to this part! ';
}
elseif(isset($_GET['ID'])) {
    $info = $UserGroups->SelectUserGroups('1','',$_GET['ID'],'','','','','1');
                    ...
                    <div class="col-sm-12">
                        <div class="panel panel-flat" style="padding-top: 15px;">
                            <?php if($show_page == '1') { ?>
                                ...
                                <form action="UsersGroups_action.php?action=edit&ID=<?php echo $row_info['ID']; ?>" method="post" target="_blank">
                                    <div class="col-sm-12">
                                        <div class="col-sm-4">
                                    ...
                                    <div class="col-sm-12">
                                        <?php
                                        $list_privilege = $UserGroups->SelectUserGroups('','1','','','','PartID, ItemID, ID','ASC','');
                                        $option_count = mysqli_num_rows($list_privilege);
                                        $i = '1';
                                        $last_break = '';
                                        while($row_list_privilege = mysqli_fetch_assoc($list_privilege)){
                                            if(($i%4) == '1') {
                                                $last_break = $i;
                                                ?>
                                                <div class="row">
                                            ...
                                            <div class="col-sm-3">
                                                <input type="checkbox" name="Privileges[]" value="<?php echo $row_list_privilege['Name']; ?>" <?php if($UserGroups->CheckGroupAndPrivilegeRelation($row_info['ID'],$row_list_privilege['Name']) != '0'){ ?> checked <?php } ?> >
                                                 <?php echo $row_list_privilege['En']; ?>
                                            </div>
                                            <?php
